    ...
    <footer>
        <div id="footer_wrap">
            <ul>
                ...
                <li><a href="#a"><span class="underbold">개인정보처리방침</span></a></li>
            ...
            대표이사 : 허민회 · 사업자등록번호 : 104-81-45690 · 통신판매업신고번호 : 2017-서울용산-0062 <span class="under">사업자정보확인</span><br>
            ...
            <button type="button" class="btn_familysite" onclick="goFamilySite()">GO</button>
        </div>
    </footer>
</body>
</html>